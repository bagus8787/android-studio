package com.example.dicoding.Adapater;
...
import com.example.dicoding.CustomOnItemClickListener;
import com.example.dicoding.Entity.Note;
import com.example.dicoding.FormAddUpdateActivity;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int position)
    {
        ...
        holder.tvDescription.setText(getListNotes().get(position).getDerscription());
