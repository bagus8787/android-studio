...
public class FormAddUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtDeskripsi = (EditText)findViewById(R.id.edt_description);
        ...
        if (isEdit){
            ...
            edtDeskripsi.setText(note.getDerscription());
        }else {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit){
            ...
            String description = edtDeskripsi.getText().toString().trim();

            boolean isEmpty = false;

            ////Jika fieldya masih kosong akan tampil error////

            if (TextUtils.isEmpty(title)){
                isEmpty = true;
                edtTitle.setError("Ini harus di isi nggeh");
            }
            if (!isEmpty){
                ...
                //Jika merupakan edit setresultnya UPDATE ,dan jika bukan maka setresultmya ADD//
                if (isEdit){
    ...
    private void showAlertDialog(int type){
        ...
        if (isDialogClose){
            ...
            dialogMessage = "Apakah anda yakin ingin menghapus kenangannya ?";
