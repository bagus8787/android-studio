...
public class FormUserPreferenceActivity extends AppCompatActivity implements  View.OnClickListener{
    ...
    EditText edtNama, edtPhone, edtAge, edtEmail;
    RadioGroup rgLoveMu;
    ...
    final String FIELD_DIGITAL_ONLY = "Hanya boleh tersimpan numerik";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String actionBarTile = null;
        String btnTitle = null;

        if (formType == 1){
            actionBarTile = "Tambah Baru";
            btnTitle = "Simpan";
        }else {
            actionBarTile = "Ubah";
            btnTitle = "Update";
        ...
        getSupportActionBar().setTitle(actionBarTile);
        ...
        if ( view.getId() == R.id.btn_save){
            ...
            boolean isLoveMu = rgLoveMu.getCheckedRadioButtonId() == R.id.rb_yes;
                ...
                if (TextUtils.isEmpty(phone)){
                    ...
                    isEmpty = true;
                    edtPhone.setError(FIELD_DIGITAL_ONLY);
                }

                if (!isEmpty){
                    mUserPreference.setNama(nama);
                    mUserPreference.setAge(Integer.parseInt(age));
                    mUserPreference.setEmail(email);
                    mUserPreference.setPhoneNumber(phone);
    ...
    private void showPreferenceInForm(){
        edtNama.setText(mUserPreference.getNama());
        edtEmail.setText(mUserPreference.getEmail());
        edtAge.setText(mUserPreference.getAge());
