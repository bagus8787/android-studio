...
import com.example.dicoding.Adapater.NoteAdapter;
import com.example.dicoding.Entity.Note;
import com.example.dicoding.db.NoteHelper;

import java.util.ArrayList;
import java.util.LinkedList;

import static com.example.dicoding.FormAddUpdateActivity.REQUEST_UPDATE;

public class MyNotesApp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_notes_app);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.fab_add){
            Intent intent = new Intent(MyNotesApp.this, FormAddUpdateActivity.class);
    ...
    protected void onActivityResult(int requsetCode, int resultCode, Intent data){
        ...
        if (requsetCode == FormAddUpdateActivity.REQUEST_ADD){
        ...
        else if (requsetCode == REQUEST_UPDATE){
